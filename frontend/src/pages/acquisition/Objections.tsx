...
import { ObjectionPanel } from "../../components/acquisition/ObjectionPanel";
...
export function Objections() {
  ...
  if (!activeCase) {
    return <AppCard title="Objections" description="No acquisition cases available." />;
  }

  return (
    <div className="grid gap-4 xl:grid-cols-[0.8fr_1.2fr]">
      <AppCard title="Objection cases" description="Open cases with disputes and objections.">
            ...
            >
              <div className="flex items-center justify-between gap-3">
                <div>
                  ...
                  <p className="mt-2 text-sm leading-6 text-slate-600">{entry.objections.length} objections logged</p>
                </div>
      ...
      <ObjectionPanel acquisitionCase={activeCase} />
    </div>
  );
}
