...
import { NotificationPanel } from "../../components/acquisition/NotificationPanel";
...
export function Notifications() {
  ...
  if (!activeCase) {
    return <AppCard title="Notifications" description="No acquisition cases available." />;
  }

  return (
    <div className="grid gap-4 xl:grid-cols-[0.8fr_1.2fr]">
      <AppCard title="Notification queue" description="Review operational notices and alerts.">
            ...
            >
              <div className="flex items-center justify-between gap-3">
                <div>
                  ...
                  <p className="mt-2 text-sm leading-6 text-slate-600">{entry.notifications.length} notices</p>
                </div>
      ...
      <NotificationPanel acquisitionCase={activeCase} />
    </div>
  );
}
